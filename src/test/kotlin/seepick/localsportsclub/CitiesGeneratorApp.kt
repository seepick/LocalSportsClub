...
object CitiesGeneratorApp {
    ...
    fun main(args: Array<String>) {
        ...
        val result = buildString {
            appendLine("package seepick.localsportsclub.service.model")
            appendLine()
            appendLine("// generated by ${CitiesGeneratorApp::class.qualifiedName}")
    ...
    private fun parse(): List<Country> {
        ...
        return html.select("div.panel-default").map { countryHtml ->
            Country(label = countryHtml.select("span.usc-city-dropdown__country-name").text().trim(),
                cities =
